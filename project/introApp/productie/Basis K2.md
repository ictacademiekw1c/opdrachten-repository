# 2. B1-K2: Realiseert en test (onderdelen van) een product
...
### Opdracht B: Realiseren van de database
    ...
    Volg daarbij de volgende stappen. 
      ...
      c. Vul de tabellen in de database zo nodig aan met testgegevens ten behoeve van de realisatie.
...
__Resultaat__
        ...
        - De werkende onderdelen van de applicatie die je gemaakt hebt.
            - De applicatie is gebouwd met de volgende software standaard ideeen:
                ...
                Alternatief aan OOP/3-tier mag ook zijn een software architectuur die:
                - robuust is en goed is te debuggen
                - consequent is doorgevoerd
                - schaalbaar en uitbreidbaar is 
